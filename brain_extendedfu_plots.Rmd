...
ggplot(#data = subset(rbans.data, del.cat != '1-2 days delirium'),
       data = rbans.data,
  ...
  geom_line(aes(group = id, colour = del.cat), alpha = 0.35) +
  geom_smooth(aes(colour = del.cat, fill = del.cat), alpha = 0.5, method = 'gam') +
  scale_x_continuous(name = NULL,
                     breaks = c(1, 12/3, 48/3),
                     labels = c('3M', '12M', '4 Years')) +
  scale_y_continuous(name = NULL,
                     breaks = c(60, 78, 85, 100, 115),
                     labels = c('60', '78 (CI)', '\n85\n(Low Normal)',
                                '\n100\n(Pop. Normal)', '\n115\n(High Normal)')) +
  scale_color_viridis(end = 0.75, discrete = TRUE) +
  scale_fill_viridis(end = 0.75, discrete = TRUE) +
  theme_minimal() +
  theme(#panel.background = element_rect(fill = 'grey98'),
        axis.text = element_text(hjust = 1, size = 8, face = 'bold'),
        axis.ticks.x = element_blank(),
